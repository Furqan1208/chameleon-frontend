...
import { AlertTriangle, ArrowLeft, CheckCircle, Copy, Lock, Shield } from "lucide-react";
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <p className="mt-1 font-[var(--font-jetbrains-mono)] text-[10px] text-muted-foreground/50">{user.id}</p>
                            </div>
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
              ...
              <div>
                ...
                <form onSubmit={handleResetPassword} className="space-y-4">
                  ...
                  <div>
                    <div className="mb-2">
                      <label className="mb-1 block font-[var(--font-inter)] text-xs text-muted-foreground">
                        New Password
                      </label>
                      <p className="font-[var(--font-inter)] text-xs text-muted-foreground">
                  ...
                  <div>
                    <label className="mb-2 block font-[var(--font-inter)] text-xs text-muted-foreground">
                      Confirm Password
                    </label>
                    <input
                      type="password"
