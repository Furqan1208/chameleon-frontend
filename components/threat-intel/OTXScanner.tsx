    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="px-3 py-2 rounded-lg border border-border bg-card/50 text-xs text-muted-foreground flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg border border-border bg-card/50 text-muted-foreground hover:text-foreground hover:border-border disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 text-sm"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="rounded-lg border border-border bg-card p-3">
          ...
          <p className="text-xl font-semibold text-foreground">OTX</p>
        </div>
      </div>
      ...
      {results.length > 0 ? (
        ...
        <div className="rounded-lg border border-border bg-card p-8 text-center">
          ...
          <h4 className="text-foreground font-semibold">No Searches Yet</h4>
