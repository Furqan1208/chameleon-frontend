// D:\FYP\Chameleon Frontend\components\analysis\index.ts
export { default as ParsedAnalysisDashboard } from './ParsedAnalysisDashboard'
export { default as AIAnalysisDashboard } from './AIAnalysisDashboard'  // Add this
