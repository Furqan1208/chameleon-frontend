...
export default function ViewCard({
  ...
  const colorClasses = {
    emerald: "bg-emerald-500/15 text-emerald-300 border-emerald-400/40 hover:bg-emerald-500/20",
    green: "bg-green-500/15 text-green-300 border-green-400/40 hover:bg-green-500/20",
    teal: "bg-teal-500/15 text-teal-300 border-teal-400/40 hover:bg-teal-500/20",
    cyan: "bg-cyan-500/15 text-cyan-300 border-cyan-400/40 hover:bg-cyan-500/20",
    lime: "bg-lime-500/15 text-lime-300 border-lime-400/40 hover:bg-lime-500/20",
